            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="empcode" class="col-md-4 col-form-label text-md-end">{{ __('Employee Code') }}</label>

                            <div class="col-md-6">
                                <input id="emp-code" type="text" class="form-control @error('emp_code') is-invalid @enderror" name="emp_code" value="{{ old('emp_code') }}"  autocomplete="off" autofocus>
